...
todos:
  - id: create-script
    content: Create PluginRandomizer.control.js with init, observers, UI settings, and randomize logic
    status: completed
  - id: install-script
    content: Copy script to ~/Bitwig Studio/Controller Scripts/ for Bitwig to detect it
    status: completed
isProject: false
---
